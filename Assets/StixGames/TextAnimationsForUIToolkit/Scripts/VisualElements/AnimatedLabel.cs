...
namespace TextAnimationsForUIToolkit
{
    ...
    public partial class AnimatedLabel : TextElement, IAnimatedTextElement
    {
#if !UNITY_2023_2_OR_NEWER
        ...
        public new class UxmlTraits : Label.UxmlTraits
        {
            ...
            {
                base.Init(ve, bag, cc);
                var animatedLabel = (AnimatedLabel)ve;
                var settings = _settings.GetValueFromBag(bag, cc);
                animatedLabel.Initialize(settings);
            }
        }
